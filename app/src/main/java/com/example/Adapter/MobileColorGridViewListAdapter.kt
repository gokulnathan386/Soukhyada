...
import com.soukhyada.soukhyadanew.PickUpRepairService.PickUpRepairServiceActivity



internal class MobileColorGridViewListAdapter(
    private val context: Context
) : RecyclerView.Adapter<MobileColorGridViewListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.seriesLayout.setOnClickListener{
            val intent = Intent(context, PickUpRepairServiceActivity::class.java)
