...
import com.soukhyada.soukhyadanew.Repair.MobileModelColorActivity

internal class MobileModelRepairListAdapter(
    private val context: Context
) : RecyclerView.Adapter<MobileModelRepairListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.seriesLayout.setOnClickListener{
            val intent = Intent(context, MobileModelColorActivity::class.java)
