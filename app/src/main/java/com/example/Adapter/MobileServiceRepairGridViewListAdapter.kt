...
import com.soukhyada.soukhyadanew.Repair.MobileSeriesActivity


internal class MobileServiceRepairGridViewListAdapter(
    private val context: Context
) : RecyclerView.Adapter<MobileServiceRepairGridViewListAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.seriesLayout.setOnClickListener{
            val intent = Intent(context, MobileSeriesActivity::class.java)
